...
(function () {
  ...
  function injectCSS() {
    ...
    style.textContent = [
      ...
      /* drawer */
      '.pz-drawer { position:fixed;top:0;right:-110%;width:100%;max-width:420px;height:100%;background:#fff;z-index:9999;transition:right .35s cubic-bezier(.4,0,.2,1);display:flex;flex-direction:column;box-shadow:-4px 0 24px rgba(0,0,0,.14); }',
      ...
      '.pz-dclose { background:none;border:none;font-size:1.4em;cursor:pointer;color:#888;padding:4px; }',
      '.pz-dbody { flex:1;overflow-y:auto;padding:16px 20px; }',
      ...
      '.pz-qty-btn { width:28px;height:28px;border:1.5px solid #ddd;border-radius:6px;background:#f7f7f7;cursor:pointer;font-size:1em;font-weight:700;display:flex;align-items:center;justify-content:center;transition:border-color .15s; }',
      ...
      '.pz-dfooter { padding:16px 20px;border-top:1px solid #eee; }',
      ...
      '.pz-btn-ck { display:block;width:100%;padding:16px;background:var(--pz);color:#fff;border:none;border-radius:50px;font-size:.97em;font-weight:700;letter-spacing:.5px;text-transform:uppercase;cursor:pointer;margin-top:14px;transition:box-shadow .2s; }',
      ...
      '.pz-modal { background:#fff;width:100%;max-width:500px;max-height:100vh;overflow-y:auto;border-radius:20px 20px 0 0;position:relative; }',
      '@media(min-width:580px) { .pz-modal { border-radius:16px;max-height:92vh; } }',
      '.pz-mhead { position:sticky;top:0;background:#fff;padding:16px 20px;border-bottom:1px solid #eee;display:flex;justify-content:space-between;align-items:center;z-index:2; }',
      '.pz-mhead-title { font-size:1em;font-weight:700; }',
      '.pz-mclose { width:30px;height:30px;border:none;background:#f3f3f3;border-radius:50%;cursor:pointer;font-size:.95em;color:#666;display:flex;align-items:center;justify-content:center; }',
      ...
      '.pz-inp { width:100%;border:1.5px solid #ddd;border-radius:9px;padding:11px 13px;font-size:16px;color:#222;background:#f8f8f8;outline:none;transition:border-color .2s;font-family:inherit; }',
      ...
      '.pz-cep-g .pz-inp { flex:1; }',
      '.pz-btn-cep { flex-shrink:0;border:1.5px solid #ddd;border-radius:9px;padding:0 14px;background:#f3f3f3;font-size:.82em;font-weight:600;color:#666;cursor:pointer;font-family:inherit;white-space:nowrap; }',
      '.pz-actions { display:flex;gap:10px;margin-top:18px;padding-top:14px;border-top:1px solid #eee; }',
      '.pz-btn-back { flex-shrink:0;border:1.5px solid #ddd;border-radius:50px;padding:13px 18px;background:none;font-size:.87em;font-weight:600;color:#888;cursor:pointer;font-family:inherit; }',
      '.pz-btn-next { flex:1;border:none;border-radius:50px;padding:15px;background:var(--pz);color:#fff;font-size:.93em;font-weight:700;letter-spacing:.5px;text-transform:uppercase;cursor:pointer;transition:box-shadow .2s;font-family:inherit; }',
      ...
      '.pz-pix-amount { font-size:2.5em;font-weight:700;color:var(--pz);letter-spacing:-.02em;line-height:1; }',
      ...
      '#pz-qrcode { width:200px;height:200px;margin:0 auto 16px;padding:10px;background:#fff;border:1px solid #eee;border-radius:12px; }',
      ...
      '.pz-btn-copy { display:block;width:100%;padding:15px;background:#222;color:#fff;border:none;border-radius:50px;font-size:.92em;font-weight:700;letter-spacing:.5px;text-transform:uppercase;cursor:pointer;transition:background .2s;margin-bottom:18px;font-family:inherit; }',
      ...
      '.pz-btn-retry { background:#f3f3f3;border:1.5px solid #ddd;border-radius:50px;padding:10px 22px;font-size:.86em;font-weight:600;color:#444;cursor:pointer;font-family:inherit; }',

      /* confirmação */
      '.pz-done { text-align:center;padding:50px 20px; }',
      '.pz-done-icon { font-size:3.2em;margin-bottom:16px; }',
      '.pz-done h3 { font-size:1.45em;font-weight:700;margin-bottom:10px; }',
      '.pz-done p { color:#888;font-size:.93em;line-height:1.7; }',
      '.pz-btn-done { margin-top:22px;background:var(--pz);color:#fff;border:none;border-radius:50px;padding:13px 34px;font-size:.93em;font-weight:700;cursor:pointer;font-family:inherit; }',

      /* cart badge */
      '.pz-cart-badge { position:fixed;top:12px;right:16px;z-index:9997;background:var(--pz);color:#fff;border-radius:50px;padding:8px 14px;font-size:.82em;font-weight:700;cursor:pointer;box-shadow:0 4px 16px rgba(157,18,63,.35);transition:transform .2s,box-shadow .2s;display:none;align-items:center;gap:7px; }',
